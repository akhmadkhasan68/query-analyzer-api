...
export class InitDatabase1754838155560 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'CREATE TABLE "storage_file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying(255) NOT NULL, "path" character varying(255) NOT NULL, "size" integer NOT NULL, "mimetype" character varying(50) NOT NULL, "driver" character varying(50) NOT NULL, CONSTRAINT "PK_b227a0824aac2dd9136c5052d8a" PRIMARY KEY ("id"))',
        );
        await queryRunner.query(
            'CREATE TABLE "role_permissions" ("permissions_id" uuid NOT NULL, "roles_id" uuid NOT NULL, CONSTRAINT "PK_3a2404462ad8373a26704fb1f1c" PRIMARY KEY ("permissions_id", "roles_id"))',
        );
        await queryRunner.query(
            'CREATE INDEX "IDX_bae04782e4d2b4d4c978528970" ON "role_permissions" ("permissions_id") ',
        );
        await queryRunner.query(
            'CREATE INDEX "IDX_ad074b0f95ff0488162868be2c" ON "role_permissions" ("roles_id") ',
        );
        await queryRunner.query(
            'CREATE TABLE "user_roles" ("roles_id" uuid NOT NULL, "users_id" uuid NOT NULL, CONSTRAINT "PK_65ec3daed53f391c53df7e2e8fb" PRIMARY KEY ("roles_id", "users_id"))',
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            'ALTER TABLE "permissions" ADD CONSTRAINT "FK_466e789688587a5013d6e873310" FOREIGN KEY ("operation_id") REFERENCES "operations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION',
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'ALTER TABLE "role_permissions" DROP CONSTRAINT "FK_ad074b0f95ff0488162868be2c7"',
        );
        await queryRunner.query(
            'ALTER TABLE "role_permissions" DROP CONSTRAINT "FK_bae04782e4d2b4d4c978528970c"',
        );
        await queryRunner.query(
            'ALTER TABLE "user_tokens" DROP CONSTRAINT "FK_9e144a67be49e5bba91195ef5de"',
        );
        await queryRunner.query(
            'ALTER TABLE "permissions" DROP CONSTRAINT "FK_466e789688587a5013d6e873310"',
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            'DROP INDEX "public"."IDX_ad074b0f95ff0488162868be2c"',
        );
        await queryRunner.query(
            'DROP INDEX "public"."IDX_bae04782e4d2b4d4c978528970"',
        );
